...
namespace UnityWebGLSpeechSynthesis
{
    public class Example01Synthesis : MonoBehaviour
    {
        ...
        /// </summary>
        private static Example01Synthesis _sInstance = null;

        /// <summary>
        /// Get the example instance
        /// </summary>
        /// <returns></returns>
        public static Example01Synthesis GetInstance()
        {
            return _sInstance;
        }
        ...
        private void Speak()
        {
            // check the input field reference is set
            ...
            // if the text field is blank, there's nothing to speak
            if (string.IsNullOrEmpty(_mInputField.text))
            {
                return;
            }

            // speak the text in the text field
            SpeakText(_mInputField.text);
        }
