...
namespace UnityWebGLSpeech
{
    public class Example02DictationSbaitso : MonoBehaviour
    {
        ...
        /// </summary>
        private bool _mContinuePressed = false;
        ...
        IEnumerator Start()
        {
            // wait to make the continue button interactable
            SpeechSynthesisUtils.SetInteractable(false, _mButtonContinue);
            ...
            SpeechSynthesisUtils.SetInteractable(true, _mButtonContinue);
            ...
            foreach (SpeechRecognitionResult result in results)
            {
                ...
                foreach (SpeechRecognitionAlternative alternative in alternatives)
                {
                    ...
                    if (result.isFinal)
                    {
                        ...
                        // clear the continue button state if final
                        _mContinuePressed = false;
